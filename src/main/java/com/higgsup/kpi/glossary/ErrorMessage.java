...
public final class ErrorMessage {
    ...
    public final static String INVALIDATED_ORGANIZERS_PRIZE = "invalidated organizers score";
    ...
    public final static String TEAM_BUILDING_HAS_BEEN_EXISTED = "team building has been existed";
    ...
    public final static String TEAM_BUILDING_ORGANIZERS_SCORE_CAN_NOT_NULL = "the organizers score can not be null";
