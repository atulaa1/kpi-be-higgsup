...
author: TuTT
purpose: 2018-10-01-1514 change database for calculating point of employee
**/
...
CREATE TABLE kpi_event_user (
  ...
  status       TINYINT(4)  DEFAULT 0 NULL  COMMENT 'status can 0 is unfinished , 1 is finish' ,
